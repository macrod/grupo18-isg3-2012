    	...
    	<script type="text/javascript" src="js/reloaders.js"></script>
  		<script language="Javascript" type="text/javascript">
			...
			function registrar(){
				...
				window.document.formulario.action = "FrontController?accion=registrar";
				window.document.formulario.target = "_self";
				window.document.formulario.submit();
					...
					<tr><td class="cuerpo_login" height="100">
						<table width="100%" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="70%" align=left><input name="usuario" type="text" class="texto_login" id="usuario" size="30"></td>
							</tr>
							<tr>
								<td width="30%" class="etiqueta_login"><span class="etiqueta">Contraseña&nbsp;&nbsp;</span>&nbsp;</td>
								<td width="70%" align=left><input name="clave" type="password" class="texto_login" id="clave" size="30"></td>
							</tr>
