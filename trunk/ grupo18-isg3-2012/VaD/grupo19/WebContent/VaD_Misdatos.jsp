...
//int muni_muniid = Integer.parseInt(request.getParameter("muni_muniid"));
	...
	JDBCUsuarioDAO jdaousua = new JDBCUsuarioDAO();
	Usuario datosusuario = jdaousua.recuperarUsuarioByIdUsuario(usua_id);
...
<%
	...
	request.getRequestDispatcher("SVL_Logar_Registrar.jsp").include(request,response);
}  
%> 	
  	</body>
</html>