...
public class ServletGuardarRegistro extends HttpServlet {
	...
	private static Logger logger = Logger.getLogger(ServletGuardarRegistro.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ( usua_usuario != null && usua_clave != null && !"".equals(usua_usuario) && !"".equals(usua_clave) ){
			...
			String usua_fbaja = "";
			/*try {
				usua_falta =  (Date)sdf.parse(fecha);
			...
			if(dedonde != null && dedonde.equals("logar_registrar"))
		    {
				try {
					...
					int usua_id = procesoregistro.recuperarIDByUsername(usua_usuario);
					...
					logger.debug("Nos vamos a registrar los servicios..");
					if(usua_perfil != null && usua_perfil.equals("voluntario"))
				    {
			...
			*/
			...
			logger.debug("Si ya existe el usuario");
		...
		logger.debug("Si el usuario o la clave no son correctas");
