...
public class RegistroProcessor implements IRegistroProcessor {
	...
	public void registrarUsuario(Usuario usuario,String perfil) {
		...
		String nombre = usuario.getUsua_usuario();
		...
		// Tercero lo damos de alta en la tabla voluntarios
		
		//inserta los servicios a los que se va a dar de alta como voluntario
		//sdao.insertarUsuarioServicios(usua_id, serv_id);
